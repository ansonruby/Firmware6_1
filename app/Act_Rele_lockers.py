...
class ACTUADOR_RELES(object):
    ...
    def Configurar_Relevos(self):
        ...
        if self.Comunicacion_Rele == 'Rele':     #Para dispositivos con relevos
            ...
            self.Rele_close(k)
    #-----------------------------------------------------------
    def Rele_close(self, Direc):
        global Reles
        self.Rele_HIGH( Direc)
    ...
    def Actividad_Rele(self, Direc):
        global Reles
        self.Rele_LOW(Direc)    #GPIO.output(Reles[self.Selec_Puerta][Direc], GPIO.LOW)
        time.sleep(self.Duracion_Accion)
        self.Rele_HIGH( Direc)  #GPIO.output(Reles[self.Selec_Puerta][Direc], GPIO.HIGH)
    #-----------------------------------------------------------
    def Rele_HIGH(self, Direc):
        global Reles
        GPIO.output(Reles[self.Selec_Puerta][Direc], GPIO.HIGH)
    #-----------------------------------------------------------
    def Rele_LOW(self, Direc):
        global Reles
