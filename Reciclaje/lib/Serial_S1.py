...
def Activar_QR():
    Set_File(STATUS_QR_S1, '1')    #Escrivir_Estados('1',8) # Cambiar estado del QR
...
def Activar_Telado():
    Set_File(STATUS_TECLADO_S1, '1')    #Escrivir_Estados('1',8) # Cambiar estado del QR
...
def Activar_Tag():
    Set_File(STATUS_NFC_S1, '1')    #Escrivir_Estados('1',8) # Cambiar estado del QR
    #Set_File(STATUS_TECLADO_S1, '1')    #Escrivir_Estados('1',8) # Cambiar estado del QR
...
def Guardar_Tag(Tag):
    ...
    #Clear_File(COM_TECLADO_S1)          # Borrar QR
    #Set_File(COM_TECLADO_S1, '6.' + TagG)       # Guardar QR
